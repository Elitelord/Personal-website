  ...
  return (
    <div className="grid grid-cols-1 laptop:grid-cols-2 gap-6">
      ...
      <a
        ...
        className="group relative overflow-hidden rounded-surface bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 transition-colors duration-200 hover:border-gray-400 dark:hover:border-zinc-600 cursor-pointer block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-black"
      >
        <div className="p-5 pb-3">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-control bg-amber-500 flex items-center justify-center">
            ...
            <span className="font-mono text-xs text-gray-400 dark:text-zinc-500 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200 flex items-center gap-1">
              View Profile
      ...
      >
        <div className="relative z-10 p-5 pb-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-control bg-emerald-600 flex items-center justify-center">
          ...
          {/* Star Ratings */}
          <div className="mb-5">
            <h4 className="font-mono text-[11px] uppercase tracking-[0.15em] text-gray-400 dark:text-zinc-500 mb-3">Skill Ratings</h4>
          ...
          {/* Certifications */}
          <div>
            <h4 className="font-mono text-[11px] uppercase tracking-[0.15em] text-gray-400 dark:text-zinc-500 mb-3">Certifications</h4>
            <div className="flex flex-wrap gap-2">
              {hackerrank.certifications.map((cert) => (
                <span
                  key={cert}
                  className="inline-block px-2 py-1 rounded-control border border-gray-200 dark:border-zinc-700 font-mono text-xs text-gray-600 dark:text-gray-400"
                >
                  {cert}
                </span>
              ))}
